...
def main():
    ...
    try:
        ...
        print(f"Producing {args.count} message(s) of schema version {args.schema_version} to topic '{kafka_topic}'...\n")
        ...
        print(f"Error: Could not connect to Kafka. Is Redpanda running? Details: {e}", file=sys.stderr)
        sys.exit(1)
