...
echo "  StarRocks SQL (MySQL)    mysql://root@localhost:9030"
echo ""
...
echo "  🐕 Sink Watchdog         ./bin/watch_sink_failures.sh"
...
echo "  StarRocks smoke test     ./bin/4_run_starrocks.sh"
echo ""

echo "📖 Documentation"
echo "────────────────────────────────────────────────────────────────"
echo "  📄 Kafka Sink Setup      ./docs/KAFKA_SINK_SETUP.md"
echo "  📊 Monitoring Guide      ./docs/RISINGWAVE_MONITORING_GUIDE.md"
